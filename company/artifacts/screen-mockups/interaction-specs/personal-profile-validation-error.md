# Personal Profile — Validation Error Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#personal-profile-validation-error`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#personal-profile-validation-error/error`
...
- Prompt: `company/artifacts/screen-mockups/prompts/personal-profile-validation-error.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Field-specific validation that preserves valid personal-profile entries and optional-field choices.
...
| --- | --- | --- |
| Continue | Click/tap; Enter or Space when focused | Advance to the next PRD-defined step after validating the current state. |
