# Live Styling — Changing Item Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-changing-item`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-changing-item/changing`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-changing-item.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

In-session state while a new recommended item is being applied.
