# Live Styling — Hand Gesture Guide Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-hand-gesture-guide`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-hand-gesture-guide/base`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-hand-gesture-guide.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Distance-control guide and active interpretation overlay showing supported hand gestures, camera framing, recognition state, intended action, and consequential-action confirmation.
...
| --- | --- | --- |
| Turn on hand controls | Click/tap; Enter or Space when focused | Enter, pause, or demonstrate hand-control mode without changing unrelated session state. |
| Practice | Click/tap; Enter or Space when focused | Enter, pause, or demonstrate hand-control mode without changing unrelated session state. |
