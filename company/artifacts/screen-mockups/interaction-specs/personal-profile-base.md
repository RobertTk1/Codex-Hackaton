# Personal Profile — Base Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#personal-profile-base`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#personal-profile-base/base`
...
- Prompt: `company/artifacts/screen-mockups/prompts/personal-profile-base.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

First onboarding step for preferred name, adult confirmation, age, height, optional weight, and style-presentation context.
...
| --- | --- | --- |
| Choose my brands | Click/tap; Enter or Space when focused | Save the profile fields and navigate to `/style-report/brands-and-sizes`. |
