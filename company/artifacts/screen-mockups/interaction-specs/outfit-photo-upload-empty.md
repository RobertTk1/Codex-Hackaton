# Outfit Photo Upload — Empty Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#outfit-photo-upload-empty`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#outfit-photo-upload-empty/empty`
...
- Prompt: `company/artifacts/screen-mockups/prompts/outfit-photo-upload-empty.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Photo guidance, analysis consent, upload entry, count rules, and image-use explanation before any image is selected.
...
| --- | --- | --- |
| Choose photos | Click/tap; Enter or Space when focused | Open the supported image picker and validate selected files without removing accepted photos. |
