# Live Styling — Voice Failure Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-voice-failure`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-voice-failure/recovery`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-voice-failure.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Unrecognized or unmatched voice request with retry and direct-control recovery.
