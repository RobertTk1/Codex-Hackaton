# Outfit Photo Upload — Partial Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#outfit-photo-upload-partial`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#outfit-photo-upload-partial/partial`
...
- Prompt: `company/artifacts/screen-mockups/prompts/outfit-photo-upload-partial.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Grid of uploaded and validating images with count progress, replacement, removal, and continue behavior.
...
| --- | --- | --- |
| Refine my taste | Click/tap; Enter or Space when focused | Navigate to `/style-report/taste` when the required photos are ready. |
| Add more photos | Click/tap; Enter or Space when focused | Open the supported image picker and validate selected files without removing accepted photos. |
