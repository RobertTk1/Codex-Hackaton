# Live Styling — Microphone Permission Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-microphone-permission`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-microphone-permission/permission`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-microphone-permission.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Separate microphone permission explanation with direct-control alternative.
...
| --- | --- | --- |
| Turn on microphone | Click/tap; Enter or Space when focused | Request browser microphone permission and enter listening only after approval. |
| Use buttons instead | Click/tap; Enter or Space when focused | Return focus to the on-screen direct controls without changing the current item. |
