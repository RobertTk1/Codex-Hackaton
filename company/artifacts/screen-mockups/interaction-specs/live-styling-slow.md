# Live Styling — Slow Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-slow`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-slow/slow`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-slow.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Explicit slow state for an awaited live visualization update.
...
| --- | --- | --- |
| Keep waiting | Click/tap; Enter or Space when focused | Perform the approved “Keep waiting” action for live-styling-slow and preserve unrelated customer work. |
| Choose another look | Click/tap; Enter or Space when focused | Load the next recommended item in the same live-styling workspace. |
| Back to my picks | Click/tap; Enter or Space when focused | Perform the approved “Back to my picks” action for live-styling-slow and preserve unrelated customer work. |
