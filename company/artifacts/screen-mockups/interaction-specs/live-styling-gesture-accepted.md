# Live Styling — Gesture Accepted Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-gesture-accepted`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-gesture-accepted/accepted`
- Exact copy: `company/artifacts/copy/copy-manifest.json#live-styling-gesture-accepted/accepted`
- Visual system: `company/artifacts/screen-mockups/design-direction.md`
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-gesture-accepted.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Accepted non-consequential gesture with action feedback.
...
| --- | --- | --- |
| Keep styling | Click/tap; Enter or Space when focused | Perform the approved “Keep styling” action for live-styling-gesture-accepted and preserve unrelated customer work. |
| Undo | Click/tap; Enter or Space when focused | Reverse the immediately preceding reversible choice and restore the prior state. |
...
Show a brief successful gesture result with undo and continued-control choices.
