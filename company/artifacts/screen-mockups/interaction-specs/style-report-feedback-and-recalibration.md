# Style Report — Feedback and Recalibration Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#style-report-feedback-and-recalibration`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#style-report-feedback-and-recalibration/feedback`
...
- Prompt: `company/artifacts/screen-mockups/prompts/style-report-feedback-and-recalibration.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Correction and recalibration state shared by report findings.

## Component hierarchy

1. Report navigation
2. Feedback form
3. Confirmation and next step

## Controls and behavior

| Control | Trigger | Behavior |
| --- | --- | --- |
| Update my report | Click/tap; Enter or Space when focused | Validate the feedback and refresh the affected report guidance. |
