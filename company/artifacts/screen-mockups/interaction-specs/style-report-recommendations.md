# Style Report — Recommendations Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#style-report-recommendations`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#style-report-recommendations/base`
...
- Prompt: `company/artifacts/screen-mockups/prompts/style-report-recommendations.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Prioritized silhouettes, proportions, layers, fabrics, garments, and outfit guidance tied to report evidence.
...
| Save this guide | Click/tap; Enter or Space when focused | Persist the current customer selection and confirm completion without changing unrelated state. |
