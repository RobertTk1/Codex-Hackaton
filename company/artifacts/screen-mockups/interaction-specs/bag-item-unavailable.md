# Bag — Item Unavailable Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#bag-item-unavailable`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#bag-item-unavailable/unavailable`
...
- Prompt: `company/artifacts/screen-mockups/prompts/bag-item-unavailable.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Bag state that identifies an unavailable item and offers removal or alternatives.
...
| --- | --- | --- |
| Find something similar | Click/tap; Enter or Space when focused | Open alternatives selected for the same recommendation rationale. |
| Remove it | Click/tap; Enter or Space when focused | Remove only the named item after confirmation when the consequence is not already obvious. |
| Keep styling | Click/tap; Enter or Space when focused | Perform the approved “Keep styling” action for bag-item-unavailable and preserve unrelated customer work. |
