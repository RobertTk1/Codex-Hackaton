# Live Styling — Connecting Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-connecting`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-connecting/connecting`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-connecting.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Live visualization connection state with selected product preserved.
...
| --- | --- | --- |
| Go back | Click/tap; Enter or Space when focused | Perform the approved “Go back” action for live-styling-connecting and preserve unrelated customer work. |
