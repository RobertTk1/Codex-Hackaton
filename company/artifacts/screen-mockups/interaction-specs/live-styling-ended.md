# Live Styling — Ended Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-ended`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-ended/ended`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-ended.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Completed-session summary with preserved selections and next actions.
...
| Style another look | Click/tap; Enter or Space when focused | Enter the live-styling permission or ready flow with the chosen recommendation preserved. |
| Go home | Click/tap; Enter or Space when focused | Navigate to the safest available home or resume destination without discarding progress. |
