# Live Styling — Error Recovery Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-error-recovery`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-error-recovery/recovery`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-error-recovery.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Normalized live-provider failure with retry and preserved product selection.
