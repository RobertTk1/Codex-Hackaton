# Live Styling — Gesture Confirmation Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-gesture-confirmation`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-gesture-confirmation/confirming`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-gesture-confirmation.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Explicit confirmation before a gesture triggers a consequential action.
...
| --- | --- | --- |
| {{gesture_action}} | Click/tap; Enter or Space when focused | Perform the approved “{{gesture_action}}” action for live-styling-gesture-confirmation and preserve unrelated customer work. |
