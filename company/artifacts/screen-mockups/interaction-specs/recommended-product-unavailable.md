# Recommended Product — Unavailable Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#recommended-product-unavailable`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#recommended-product-unavailable/unavailable`
...
- Prompt: `company/artifacts/screen-mockups/prompts/recommended-product-unavailable.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Unavailable recommended-product state with alternatives and preserved context.
...
| --- | --- | --- |
| See similar | Click/tap; Enter or Space when focused | Open alternatives selected for the same recommendation rationale. |
| Close | Click/tap; Enter or Space when focused | Close the current drawer or overlay and restore focus to its trigger. |
| Back to my picks | Click/tap; Enter or Space when focused | Perform the approved “Back to my picks” action for recommended-product-unavailable and preserve unrelated customer work. |
