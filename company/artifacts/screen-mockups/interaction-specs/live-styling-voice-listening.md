# Live Styling — Voice Listening Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-voice-listening`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-voice-listening/listening`
- Exact copy: `company/artifacts/copy/copy-manifest.json#live-styling-voice-listening/listening`
- Visual system: `company/artifacts/screen-mockups/design-direction.md`
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-voice-listening.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Live-session overlay showing that voice capture is active, with cancel and direct-control alternatives.
...
| --- | --- | --- |
| Stop listening | Click/tap; Enter or Space when focused | Perform the approved “Stop listening” action for live-styling-voice-listening and preserve unrelated customer work. |
...
Show an unmistakable active listening state with an example request and a visible stop action.
