# Live Styling — Voice Interpreting Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-voice-interpreting`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-voice-interpreting/interpreting`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-voice-interpreting.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Voice request interpretation state layered over the live session.
