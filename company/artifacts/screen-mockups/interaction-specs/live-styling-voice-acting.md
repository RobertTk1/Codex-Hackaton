# Live Styling — Voice Acting Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-voice-acting`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-voice-acting/acting`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-voice-acting.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Confirmed voice request being applied to the recommended item set.
