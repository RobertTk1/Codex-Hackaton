# Style Report Analysis — Processing Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#style-report-analysis-processing`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#style-report-analysis-processing/processing`
...
- Prompt: `company/artifacts/screen-mockups/prompts/style-report-analysis-processing.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Meaningful real-analysis stages, time expectation, safe-exit behavior, and current photo-lifecycle reminder.
