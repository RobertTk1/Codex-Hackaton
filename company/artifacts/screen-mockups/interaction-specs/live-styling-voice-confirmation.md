# Live Styling — Voice Confirmation Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#live-styling-voice-confirmation`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#live-styling-voice-confirmation/confirming`
...
- Prompt: `company/artifacts/screen-mockups/prompts/live-styling-voice-confirmation.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Interpreted voice request shown for confirmation before action.
...
| --- | --- | --- |
| Yes, show me | Click/tap; Enter or Space when focused | Perform the approved “Yes, show me” action for live-styling-voice-confirmation and preserve unrelated customer work. |
| Change it | Click/tap; Enter or Space when focused | Perform the approved “Change it” action for live-styling-voice-confirmation and preserve unrelated customer work. |
