# Style Report — Body Style Interaction Specification
...
- Screen contract: `company/artifacts/prd/screens.json#style-report-body-style`
- Wireframes: `company/artifacts/ui-ux-design/wireframe-manifest.json#style-report-body-style/base`
...
- Prompt: `company/artifacts/screen-mockups/prompts/style-report-body-style.md`

The copy manifest is authoritative. Generated text and imagery are visual references only.

## User job

Kibbe-informed profile, visual rationale, confidence, practical implications, and recalibration path.

## Component hierarchy

1. Report navigation
2. Body-style summary
3. Proportion guidance
4. What to wear
5. Feedback
...
| --- | --- | --- |
| See my silhouettes | Click/tap; Enter or Space when focused | Open the matching recommendation or report module while preserving the current report context. |
| Update my result | Click/tap; Enter or Space when focused | Perform the approved “Update my result” action for style-report-body-style and preserve unrelated customer work. |
