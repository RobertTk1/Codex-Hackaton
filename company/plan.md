...
1. Claim and execute `ENG-154 — Run repository quality gates in CI` in its dedicated ticket branch/worktree.
2. Continue the dependency-safe deployable-baseline sequence through `ENG-155`; fifteen tickets now pass (`ENG-001` through `ENG-006`, `ENG-008`, `ENG-013`, `ENG-014`, `ENG-024`, `ENG-039`, `ENG-043`, `ENG-046`, `ENG-152`, and `ENG-153`), and `bootstrap-deferred` remains permitted only for the named baseline prerequisites.
