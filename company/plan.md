...
1. Execute exactly one next ticket: `ENG-022 — Create extracted-garment and photo-signal records`; implement only its named extraction and photo-signal persistence contract.
