...
1. Execute exactly one next ticket: `ENG-026 — Create immutable style reports and sections`; implement only its named published report, section, lineage, and immutability contract.
