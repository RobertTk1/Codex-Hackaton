...
1. Execute exactly one next ticket: `ENG-012 — Implement catalog, bag, and handoff contracts`; preserve live-product freshness, stable-reference, and retailer-boundary rules while limiting work to shared contracts and focused fixtures.
