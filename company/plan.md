...
1. Execute exactly one next ticket: `ENG-007 — Verify anonymous, Google, and email-link authentication configuration` against the isolated development Supabase branch and the live development deployment.
