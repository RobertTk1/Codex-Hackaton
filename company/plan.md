...
1. Execute exactly one next ticket: `ENG-028 — Create generated-asset lineage and expiry records`; ENG-027 resumes immediately after this prerequisite supplies the owned accepted preview asset its pass condition requires.
