...
1. Execute exactly one next ticket: `ENG-021 — Create private customer-photo bucket policies`; implement only its named private Storage bucket and exact customer-photo access controls.
