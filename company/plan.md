...
1. Execute exactly one next ticket: `ENG-025 — Create report-run lifecycle records`; implement only its named bounded report-run persistence and lifecycle contract.
