...
1. Execute exactly one next ticket: `ENG-011 — Implement report, recommendation, and asset contracts`; preserve immutable report, current-product, and derived-asset boundaries while limiting work to shared contracts and focused fixtures.
