...
1. Execute exactly one next ticket: `ENG-027 — Create report recommendation records`; implement only its named stable product-reference, rationale, ordering, and grouping contract.
