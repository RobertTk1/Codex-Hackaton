...
1. Execute exactly one next ticket: `ENG-027 — Create report recommendation records`; implement its stable catalog references, normalized rationale, deterministic outfit grouping, and one-time owned accepted preview attachment.
