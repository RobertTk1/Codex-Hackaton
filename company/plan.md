...
1. Execute exactly one next ticket: `ENG-007 — Verify anonymous, Google, and email-link authentication configuration`; preserve the approved landing screen while validating the real authentication boundary it will later use.
