...
1. Execute exactly one next ticket: `ENG-009 — Implement profile, consent, and transfer contracts`; keep the shared contracts narrow and preserve the approved chat-first onboarding data contract.
