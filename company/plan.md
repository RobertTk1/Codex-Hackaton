...
1. Execute exactly one next ticket: `ENG-015 — Create profiles and profile revision constraints`; preserve the approved profile lifecycle, revision-concurrency, ownership, and data-minimization rules while limiting work to its migration and focused database proof.
