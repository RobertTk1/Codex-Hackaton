...
1. Execute exactly one next ticket: `ENG-020 — Create ordered photo metadata and expiry constraints`; implement only its named private-photo metadata, ordering, retention, and focused database proof.
