...
1. Execute exactly one next ticket: `ENG-023 — Create bounded taste candidates and reactions`; implement only its named Love/Hate/Maybe candidate and reaction persistence contract.
