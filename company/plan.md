...
1. Execute exactly one next ticket: `ENG-119 — Implement the report-led landing screen` from the approved desktop/mobile mockups so the development app has a real customer-facing entry point.
