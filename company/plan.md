...
1. Execute exactly one next ticket: `ENG-030 — Enforce report and generated-asset ownership policies`; prove every report, section, recommendation, and generated asset remains visible only to its current owner and unexpired authorization path.
