...
1. Execute exactly one next ticket: `ENG-010 — Implement photo, extraction, and taste contracts`; keep sensitive-media, partial-extraction, and Love/Hate/Maybe boundaries strict and limited to shared contracts and focused fixtures.
